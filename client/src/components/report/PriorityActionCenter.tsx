...
// Accept the unified finding shape (HiddenFee covers both)
...
export function PriorityActionCenter({ findings }: PriorityActionCenterProps) {
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {timelineItems.map((item, i) => {
            ...
            return (
              ...
              >
                <div className={`pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r ${
                  item.severity === "Critical" ? "from-red-500/5" :
                  item.severity === "High" ? "from-amber-500/5" :
                  item.severity === "Medium" ? "from-yellow-500/4" :
                  "from-blue-500/4"
                } to-transparent`} />
