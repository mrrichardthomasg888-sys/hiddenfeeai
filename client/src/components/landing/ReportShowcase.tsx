...
export function PricingCard() {
  ...
  return (
    <section
      id="pricing"
      className="relative scroll-mt-24 overflow-hidden bg-[#050911] py-16 sm:py-28"
    >
      <Container className="relative">
        <div className="mx-auto min-w-0 max-w-5xl overflow-hidden rounded-[24px] border border-[#f4c542]/25 bg-[#101c2e] shadow-[0_28px_80px_rgba(0,0,0,.3)] sm:rounded-[28px]">
          <div className="grid min-w-0 lg:grid-cols-[1.05fr_.95fr]">
            <div className="min-w-0 p-5 sm:p-10 lg:p-12">
              <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-[#f4c542]/25 bg-[#f4c542]/10 px-3 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-[#ffd45a] sm:px-4 sm:text-xs sm:tracking-[0.15em]">
                <Sparkles className="h-4 w-4 shrink-0" />
                <span className="min-w-0 break-words">$15 document review</span>
              </div>

              <h2 className="mt-6 max-w-full break-words text-[2.25rem] font-extrabold leading-[1.08] tracking-[-0.045em] text-white sm:text-5xl">
            ...
            <div className="min-w-0 border-t border-white/[0.08] bg-[#0c1626] p-5 sm:p-10 lg:border-l lg:border-t-0 lg:p-12">
              <p className="max-w-full break-words text-xs font-bold uppercase leading-6 tracking-[0.14em] text-[#7cc4ff] sm:text-sm sm:tracking-[0.16em]">
                Everything you need to act
              </p>

              <div className="mt-4 flex min-w-0 flex-wrap items-end gap-x-3 gap-y-1">
                <strong className="break-words text-6xl font-black leading-none tracking-[-0.06em] text-white sm:text-7xl">
                  $15
                </strong>
              ...
              <Button
                variant="violet"
                size="lg"
                className="mt-8 h-auto min-h-14 w-full whitespace-normal px-4 py-4 text-center text-sm leading-5 sm:text-base"
                onClick={startAudit}
              >
