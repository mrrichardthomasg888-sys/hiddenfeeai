...
const pageMetadata: Record<string, Metadata> = {
  ...
  "/before-you-sign": { title: "Before You Sign: AI Contract Pre-Sign Review | HiddenFeeAI", description: "Upload a contract before signing. HiddenFeeAI organizes fees, contract risks, questions to ask, and negotiation opportunities in a $15 one-time review." },
